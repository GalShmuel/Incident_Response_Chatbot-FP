      ...
      <div className="details-container">
        <div className="details-section main-info">
          ...
          <div className="details-grid">
            ...
            <DetailItem label="Description" value={finding.Description || 'No description available'} wide="true" />
          </div>
        </div>
        ...
        {finding.Resource?.S3BucketDetails && Array.isArray(finding.Resource.S3BucketDetails) && finding.Resource.S3BucketDetails.length > 0 && (
          <div className="details-section resource-info">
        ...
        <div className="details-section action-info">
